...
public class ComputeCoverageFeaturesExercisedManually {

    //private static final String TEMPLATE = "C:\\Stefan_Paper\\Paper\\2019-conf-Teclo-paper\\CaseStudies\\ArgoUML\\ArgoUML_Template";
    private static final String TEMPLATE = "C:\\Users\\gabil\\Desktop\\teste";
    //private static final String RESULTS = "C:\\Users\\gabil\\Desktop\\BonusWork\\Results\\jacoco_manually";//(new File(System.getProperty("user.home")), "StackSPL_Coverage").getAbsolutePath();
    private static final String RESULTS = "C:\\Users\\gabil\\Desktop\\teste\\results";

    public static void main(String[] args) throws IOException {


        Project project = new Project("Notepad");
        ...
        //File variantDir = new File("C:\\Users\\gabil\\Again_ArgoUMLSPL\\spl-ind\\P_ACTIVITYDIAGRAM");
        File variantDir = new File("C:\\Users\\gabil\\Desktop\\teste\\Notepad");
        //for(File variantDir : variants.listFiles()){
            //if(variantDir.isDirectory()){
                //File resultDir = new File(results, "P_ACTIVITYDIAGRAM");
                File resultDir = new File(results, "variant1");
                resultDir.mkdirs();
    ...
    private static JacocoCoverageReport parserArgoUMLVariantCoverage(File dir) throws IOException {
        ...
        File app = new File(dir, "C:\\Users\\gabil\\Desktop\\teste\\Notepad\\bin\\Notepad\\");
        //File app = new File(dir, "src\\argouml-app\\build\\");
        if(app.exists()){
            File jacocoReport = new File("C:\\Users\\gabil\\Desktop\\teste\\Notepad\\jacoco.exec");
            //File jacocoReport = new File("C:\\Users\\gabil\\Desktop\\BonusWork\\Results\\jacoco_manually\\jacoco.exec");
