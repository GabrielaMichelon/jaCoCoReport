...
public class ComputeStatementCoverageArgoUML {

    private static final String TEMPLATE = "C:\\Stefan_Paper\\GitRepo\\2019-conf-Teclo-paper\\CaseStudies\\ArgoUML\\ArgoUML_Template";

    private static final String VARIANTS = "C:\\Users\\gabil\\Again_ArgoUMLSPL2\\ecoo_threewise\\";
//    private static final String VARIANTS = "C:\\Users\\sfischer\\ArgoUMLAllFeaturesVariant\\";

    private static final String RESULTS = "C:\\Users\\gabil\\Again_ArgoUMLSPL2\\coverage\\ecco_threewise";
    ...
    private static JacocoCoverageReport parserArgoUMLVariantCoverage(File dir) throws IOException {
        ...
        //change the folder
        File sequence = new File(dir, "src\\argouml-core-diagrams-sequence2\\build\\");
        if(sequence.exists()){
